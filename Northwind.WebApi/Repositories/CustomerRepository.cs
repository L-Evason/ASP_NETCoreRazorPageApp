...
using System.IO.Compression; // To use ToArrayAsync.
...
public class CustomerRepository : ICustomerRepository
{
    ...
    {
        c.CustomerId = c.CustomerId.ToUpper(); // Normalise Id
    ...
    public async Task<Customer?> UpdateAsync(Customer c)
    {
        ...
        // If issue with SaveChangesAsync return null
        return null;
    }
    public async Task<bool?> DeleteAsync(string id)
    {
        ...
        if (affected == 1)
        {
            _memoryCache.Remove(c);
            return true;
        }
        // If delete fails return null
        return null;
    }
}